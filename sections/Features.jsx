    ...
    return (
        ...
        >
            <div className="container flex flex-col items-center p-12 md:p-6">
                <h2 className="text-6xl font-medium text-center mt-6" style={{ color: 'var(--text-primary)' }}>
                    <span style={{ color: 'var(--text-accent)' }}>Hydraze</span> makes tracking{" "}
                    <span style={{ color: 'var(--text-accent)' }} className="block">convenient</span>
                </h2>
                ...
                <div className="mt-24 grid grid-cols-1 gap-14 md:grid-cols-4 lg:grid-cols-3 text-center">
                    <FeatureCard
                        ...
                        image={<MdLightbulbOutline size={72} className="mx-auto" style={{ color: 'var(--text-accent)' }} />}
                    ...
                    <FeatureCard
                        ...
                        image={<LuGlassWater size={72} className="mx-auto" style={{ color: 'var(--text-accent)' }} />}
                        className="md:col-span-2 lg:col-span-1"
                    />
                    ...
                    <FeatureCard
                        ...
                        image={<WiDayCloudy size={80} className="mx-auto" style={{ color: 'var(--text-accent)' }} />}
